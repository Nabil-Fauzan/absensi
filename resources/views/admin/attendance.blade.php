    ...
    <script>
        ...
        function openMapModal(latitude, longitude, employeeName, timeLabel, modeText) {
            if (typeof L === 'undefined') {
                alert('Gagal memuat peta Leaflet. Silakan periksa koneksi internet Anda atau muat ulang halaman.');
                return;
            }
            ...
            setTimeout(() => {
                ...
                myMarker.bindPopup(`
                    <div class="text-sm">
                        ...
                        <span class="inline-block mt-1 px-1.5 py-0.5 text-[10px] font-bold bg-emerald-100 text-emerald-800 rounded border border-emerald-200">${modeText}</span>
                    </div>
                `).openPopup();
        ...
        function openRejectModal(id) {
            document.getElementById('rejectForm').action = `/admin/attendance/${id}/reject`;
        ...
        function copyBelumAbsenList() {
            ...
            navigator.clipboard.writeText(textToCopy).then(() => {
                ...
                const origText = btn.innerHTML;
                btn.innerHTML = '<i class="bi bi-check-lg"></i> Berhasil Disalin!';
                setTimeout(() => {
                    btn.innerHTML = origText;
                }, 2000);
            });
